		...
		<div class="member-right fr">
			...
			<div class="member-border">
				...
				<div class="member-caution clearfix">
					<form action="/home/geren/doressjia" method="post" enctype="multipart/form-data">
						{{ csrf_field() }}
						<table>
							<tr>
								<th>收件人:</th>
								<td>
									...
									<input class="ty" type="text" name="name">
								</td>
							</tr>
							<tr>
								<th>联系方式:</th>
								<td><input class="ty" type="text" name="phone"></td>
							</tr>
							<tr>
								<th>地区:</th>
								<td>
							...
							<tr>
								<th>详细地址：</th>
								<td><textarea  class="ty" name="addr"></textarea></td>
							</tr>
							<tr>
								<th>邮编:</th>
								<td><input class="ty" type="text" name="bian"></td>
							</tr>
							<tr>
								<td></td>
