...
<header id="pc-header">
	...
	<div class="pc-header-logo clearfix">
		...
		<div class="head-form fl">
			<form class="clearfix">
				<input class="search-text" accesskey="" style="height:36px;" id="key" autocomplete="off" placeholder="洗衣机" type="text">
	...
	<div class="center pc-top-20">
		<div class="pc-center-he">
			...
			<div class="pc-list-goods" style="height:auto">
					...
					<a class="saleDeal" href="/home/page/{{ $v->id }}" target="_blank">
