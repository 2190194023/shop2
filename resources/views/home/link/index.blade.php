...
<header id="pc-header">
	...
	<div class="yHeader">
		...
		<!-- 导航   end  -->
				...
				<div class="pc-login-title"><h2 align="center">申请友情链接</h2></div>
				<form action="/home/link/create" method="post" align="center">
					{{ csrf_field() }}
					<div class="pc-sign">
						<input type="text" placeholder="连接名" name="lname" >
					</div>
					<div class="pc-sign">
						<input type="password" placeholder="连接地址" name="lurl">
					</div>
					<div class="pc-submit-ss">
						<input type="submit" value="立即申请" placeholder="">
					</div>
				</form>
